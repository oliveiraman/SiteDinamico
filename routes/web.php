...
Route::get('/sobre',['as'=> 'site.sobre', function(){
 ...
 1) é necessário definir o controler na rota, para buscar os dados do banco

 Route::get('/sobre',['as'=> 'site.sobre','uses'=>'Site\PaginaController@sobre']);

 2) para criar é necessário rodar o comando
 php artisan make:controller Site\PaginaController

 3) depois na Pagina controller encaminhar ele para view
...
/*Auth::routes(); desativar rotas automática laravel registro e login*/
...
Route::group(['middleware'=>'auth'], function(){
	...
	/*COLOCANDO A ROTA DO SISTEMA DE ADMINISTRAÇÃO PROTEGITA DENTRO DA MIDDLEWARE AUTH*/
