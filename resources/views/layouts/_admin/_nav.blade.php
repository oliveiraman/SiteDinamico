...
<div class="nav-wrapper blue">
      <div class="container">
      <a href="{{ route('admin.login')}}" class="brand-logo">SisAdmin</a>
      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
      <ul class="right hide-on-med-and-down">
        <li><a href="{{ route('admin.principal')}}">Início</a></li>
        <li><a target="_blank" href="{{ route('site.home')}}">Site</a></li>
        <!--verificar se o usuário está logado para exibir o menu login caso contrario exibe o nome do usuário logado .:. Pode colocar uma foto do usuário-->
        @if(Auth::guest())
        <li><a href="{{ route('admin.login')}}">Login</a></li>
        @else
        
        <li><a class='dropdown-trigger btn' href="#!" data-target='dropdown1'>{{ Auth::user()->name }} <i class="material-icons right">arrow_drop_down</i></a></li> 
